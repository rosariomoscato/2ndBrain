      ...
      <div className="glass-panel border-neon-pink/30 max-w-lg rounded-2xl border-2 p-8 text-center">
        <div className="mb-6 flex justify-center">
          <div className="relative">
            <Terminal className="text-neon-pink glow-text h-16 w-16" />
            <div className="bg-neon-pink absolute -top-1 -right-1 h-4 w-4 animate-ping rounded-full" />
          </div>
        </div>
        <h1 className="font-display text-neon-pink glow-text mb-4 text-5xl font-bold">ERROR</h1>
        <p className="text-text-secondary mb-6">
          {error.message || "Something went wrong in the system"}
        </p>
        {error.digest && (
